package ch.asedeba.service.locale.model.entities;

import java.util.Arrays;
import java.util.List;

/**
 * <code>SupportedLocale</code> object represents one of the languages that is supported in Asedeba project You can get language code using the method {@link #getLocale()} from the
 * object.
 * <p>
...
public class SupportedLocale {
  ...
  public static final SupportedLocale RUSSIAN = new SupportedLocale("ru");
  ...
  public static SupportedLocale getSupportedLocale(String code) {
    ...
    if (RUSSIAN.code.equalsIgnoreCase(code)) {
      return RUSSIAN;
    }
