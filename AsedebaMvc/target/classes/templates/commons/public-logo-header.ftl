...
<nav class="navbar bg-white navbar-expand-lg fixed-top global-header__wrapper--logo-menus public-logo-header hm-primary-color">
    <div class="container">
            ...
            <a class="navbar-brand">
                 <img src="${url.resourcesUrl}/img/asedeba_logo.JPG" class="mr-2" alt="" width="184px">
            </a>
            ...
            <#if locale.supported?size gt 0>
                <li class="nav-item dropdown d-flex align-items-center">
                    <a class="dropdown-toggle as-primary-color" id="navbarDropdownLocal" data-bs-toggle="dropdown"
